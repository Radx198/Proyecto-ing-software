  ...
  return (
    <main className="p-4 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        ...
        <Link
          href="/dashboard/admin/proveedores/nuevo"
              ...
              {proveedores.map((proveedor) => (
                <tr key={proveedor._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 text-center">
                    {new Date(proveedor.fechaInicioContrato).toLocaleDateString('es-AR', {
                      year: 'numeric',
                      month: '2-digit',
                      day: '2-digit',
                    })}</td>
                  <td className="px-4 py-2 text-center">
                    {new Date(proveedor.fechaFinContrato).toLocaleDateString('es-AR', {
                      year: 'numeric',
                      month: '2-digit',
                      day: '2-digit',
                    })}</td>
                  ...
                  <td className="px-4 py-2 flex justify-center gap-3 whitespace-nowrap">
                    <Link
                      href={`/dashboard/admin/proveedores/editar/${proveedor._id}`}
