  ...
  return (
    <main className="p-4 max-w-6xl mx-auto flex-1">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
        ...
        <Link
          href="/dashboard/admin/ordenes/nuevo"
            ...
            <tbody>
              {ordenes.map((orden, index) => (
                <tr key={orden._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2">
                    {orden.proveedor?.nombreLegal}
                    <br />
                    <span className="text-gray-600 text-xs">{orden.proveedor?.contacto}</span>
                  </td>
                  ...
                  <td className="px-4 py-2 flex justify-center gap-3 whitespace-nowrap">
                    <Link
                      href={`/dashboard/admin/ordenes/editar/${orden._id}`}
              ...
              >
                ...
                <div className="mt-3 text-sm text-gray-700 space-y-2">
                  ...
                  <div>
                    ...
                    {orden.proveedor?.nombre} {orden.proveedor?.apellido}
                    <br />
                    <span className="text-xs text-gray-500">{orden.proveedor?.email}</span>
                  </div>
                  <div>
